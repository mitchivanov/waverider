...
async def main():
    symbol = 'BTCUSDT'
    asset_a_funds = 0.5  # Example funds in USDT (Asset A)
    asset_b_funds = 0.01  # Example funds in BTC (Asset B)
    grids = 4  # Number of grid levels
    deviation_threshold = 0.02  # 0.02 is 2% deviation
    trail_price = False  # Whether to trail the price or not
